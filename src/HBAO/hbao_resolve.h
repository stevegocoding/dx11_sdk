...
public:
	...
	void resolve_normal_depth( const texture_2d_ptr& input_normal, const texture_2d_ptr& input_depth);
	void resolve_linearize_normal_depth( const texture_2d_ptr& input_normal, const texture_2d_ptr& input_depth);
	...
	texture_2d_ptr& get_resolved_normal() { return m_rt_resolved_normal; }

private:
	void apply_resolve_normal_depth(const texture_2d_ptr& input_normal, const texture_2d_ptr& input_depth);
	void apply_resolve_linearize_normal_depth(const texture_2d_ptr& input_normal, const texture_2d_ptr& input_depth);
    ...
    ID3DX11EffectTechnique *m_resolve_nd_tech, *m_resolve_linearize_nd_tech; 
    ID3DX11EffectShaderResourceVariable *m_tex_depth_sr, *m_tex_normal_sr;
